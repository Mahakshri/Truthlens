...
You must return a raw JSON object strictly adhering to the specified schema, with no additional formatting or wrapper blocks.`;
...
// 7. Download Workspace Tarball Archive Backup
